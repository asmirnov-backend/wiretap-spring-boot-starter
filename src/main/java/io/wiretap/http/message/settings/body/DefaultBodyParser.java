...
public class DefaultBodyParser implements BodyParser {
    ...
    private JsonNode parseBody(
        ...
        if (processedBody != null &&
            ...
            return new TextNode(String.format(LIMIT_EXCEEDED, bodySettings.getEffectiveMaxBodyLength()));
        }
    ...
    private JsonNode parseBody(
        ...
        if (processedBody != null &&
            ...
            return new TextNode(String.format(LIMIT_EXCEEDED, httpBodySettings.getEffectiveMaxBodyLength()));
        }
